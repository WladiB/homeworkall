...
public class BankAccount {
    ...
    // Создайте метод deposit, который принимает
    // сумму для внесения и увеличивает баланс
    // счета на эту сумму.
    // Создайте метод withdraw, который принимает
    // сумму для снятия и уменьшает баланс счета
    // на эту сумму, если на счету достаточно
    // средств.
